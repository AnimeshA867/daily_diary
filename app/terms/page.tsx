      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-foreground">
          ...
          <section className="space-y-4">
            ...
            <p>
              Welcome to Daily Diary. By accessing or using our service, you agree to be bound by these 
              Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our service.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you and Daily Diary. We may update 
          ...
          <section className="space-y-4">
            ...
            <p>
              Daily Diary is a personal diary application that allows you to create, store, and manage 
              encrypted diary entries. Key features include:
            </p>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Keep your encryption keys secure (stored in your browser's localStorage)</li>
            ...
            <p>
              ...
              accounts that violate these Terms or for any other reason at our discretion.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              You retain all rights to the content you create in your diary entries. However, by using 
              our service, you grant us a limited license to store and process your encrypted content 
              to provide the service.
            </p>

            <h3 className="text-xl font-semibold">4.2 Content Restrictions</h3>
            <p>While your diary is private and encrypted, you agree not to use the service to:</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p>
              <strong>Important:</strong> Due to end-to-end encryption, we <strong>cannot</strong> read 
              your diary content. However, we may monitor metadata and usage patterns to detect abuse, 
              ensure security, and improve the service.
            </p>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-semibold">5. Encryption and Data Security</h2>
            
            <h3 className="text-xl font-semibold">5.1 Encryption Disclaimer</h3>
            <p>
              While we implement strong encryption (AES-GCM 256-bit), you acknowledge that:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Encryption keys are stored in your browser's localStorage</li>
              <li>If you clear browser data, you may lose access to encrypted entries</li>
              <li>We cannot recover your encrypted data if you lose your encryption keys</li>
              <li>Encryption is device-specific and does not currently sync across devices</li>
            </ul>

            <h3 className="text-xl font-semibold">5.2 Data Backup</h3>
            <p>
              It is your responsibility to back up your diary entries. We recommend regularly exporting 
              your entries. While we maintain backups, these are for disaster recovery and may not be 
              available for individual data recovery.
            </p>

            <h3 className="text-xl font-semibold">5.3 Security Incidents</h3>
            <p>
              In the event of a security breach that may affect your data, we will notify you in accordance 
          ...
          <section className="space-y-4">
            ...
            <p>
              The Daily Diary service, including its design, functionality, code, and branding, is owned 
              by Daily Diary and is protected by copyright, trademark, and other intellectual property laws.
            </p>
            <p>You may not:</p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              availability. We will attempt to provide notice of scheduled maintenance when possible.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <h3 className="text-xl font-semibold">8.2 Limitation of Liability</h3>
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, DAILY DIARY SHALL NOT BE LIABLE FOR ANY INDIRECT, 
              INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS 
              OF DATA, LOSS OF PROFITS, OR LOSS OF GOODWILL, ARISING OUT OF OR IN CONNECTION WITH YOUR 
              USE OF THE SERVICE.
            </p>
            ...
            <p>
              ...
              exceed the amount you paid us in the 12 months prior to the claim, or $100, whichever is greater.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              You agree to indemnify, defend, and hold harmless Daily Diary and its officers, directors, 
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              <a href="/privacy" className="text-accent hover:underline"> Privacy Policy</a> to 
          ...
          <section className="space-y-4">
            ...
            <ol className="list-decimal pl-6 space-y-2">
              ...
              <li>Binding arbitration, if mediation fails (except where prohibited by law)</li>
            </ol>

            <h3 className="text-xl font-semibold">13.3 Class Action Waiver</h3>
            <p>
              You agree that any proceedings to resolve disputes will be conducted on an individual basis 
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              and Daily Diary regarding the service.
            </p>
            ...
            <p>
              ...
              including but not limited to acts of God, war, riot, terrorism, natural disasters, or failures 
          ...
          <section className="space-y-4">
            ...
            <div className="bg-muted p-4 rounded-lg">
              <p><strong>Email:</strong> legal@dailydiary.app</p>
          ...
          <section className="space-y-4">
            ...
            <p>
              BY USING DAILY DIARY, YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF SERVICE, 
